...
title = 'Correspondances avec filtrage des occlusions et des changements de perspective'
...
output_path_matches = os.path.join(output_dir, 'matches_occlusions_perspective_filtered.png')
